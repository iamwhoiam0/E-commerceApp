...
class CategoryAdapter(private var menuItems: List<String>, private var drawableItems: List<Int>, private var flag: String) : RecyclerView.Adapter<CategoryAdapter.ViewHolder>() {
