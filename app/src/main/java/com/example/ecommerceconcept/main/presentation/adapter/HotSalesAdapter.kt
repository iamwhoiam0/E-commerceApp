...
import com.example.ecommerceconcept.main.data.entities.HomeStore

class HotSalesAdapter(private var homeStore: List<HomeStore>) : RecyclerView.Adapter<HotSalesAdapter.Pager2ViewHolder>() {
